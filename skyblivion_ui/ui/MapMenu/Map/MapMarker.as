...
class Map.MapMarker extends gfx.controls.Button
{
  /* CONSTANTS */
	...
	private static var ICON_MAP: Array = [
		...
		"--------",
		"AnvilMarker", "BravilMarker", "CheydinhalMarker", "ChorrolMarker", "DarkBrotherhoodMarker", "FightersGuildMarker", 
		"ICArboretumMarker", "ICArcaneUMarker", "ICArenaMarker", "ICElvenGardensMarker", "ICGreenWayMarker", "ICMarketDistrictMarker", 
		"ICPrisonMarker", "ICTalosPlazaMarker", "ICTempleDistrictMarker", "ICWaterfrontDistrictMarker", "KvatchMarker", "LeyawiinMarker", "MagesGuildMarker",
		"NineDivinesMarker", "OblivionGateMarker", "OrderOfVirtuousBloodMarker", "SkingradMarker", "ThievesGuildMarker"
	];

	// private static var UNDISCOVERED_OFFSET: Number = 80;
	private static var UNDISCOVERED_OFFSET: Number = 97;
  ...
  /* INITIALIZATION */
	...
	public function MapMarker()
	{
		...
		skyui.util.Debug.log(markerType + ": " + _iconName);
	...
	public function configUI(): Void
	{
		...
		switch (_iconName) {
			...
			case "AnvilMarker":
			case "BravilMarker":
			case "CheydinhalMarker":
			case "ChorrolMarker":
			case "ICArboretumMarker":
			case "ICArcaneUMarker":
			case "ICArenaMarker":
			case "ICElvenGardensMarker":
			case "ICGreenWayMarker":
			case "ICMarketDistrictMarker":
			case "ICPrisonMarker":
			case "ICTalosPlazaMarker":
			case "ICTempleDistrictMarker":
			case "ICWaterfrontDistrictMarker":
			case "KvatchMarker":
			case "LeyawiinMarker":
			case "MagesGuildMarker":
			case "NineDivinesMarker":
			case "OblivionGateMarker":
			case "OrderOfVirtuousBloodMarker":
			case "SkingradMarker":
			case "ThievesGuildMarker":
			case "PlayerSetMarker":
				_markerSize += _markerSize/4;
				break;
			
			case "DarkBrotherhoodMarker":
			case "FightersGuildMarker":
			case "ThievesGuildMarker":
				break;
