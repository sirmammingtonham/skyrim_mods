...
public static var SKYUI_VERSION_MAJOR: Number	= 420;
public static var SKYUI_VERSION_MINOR: Number	= 69;

public static var SKYUI_VERSION_STRING: String = (SKYUI_VERSION_MAJOR + "." + SKYUI_VERSION_MINOR + " Skyblivion");
